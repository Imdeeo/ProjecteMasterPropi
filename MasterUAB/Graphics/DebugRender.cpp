...
{
	{
		...
		m_Axis = new CRenderableVertexs();
			//new CLinesListRenderableVertexs<MV_POSITION_COLOR_VERTEX>(_Device, l_AxisVtxs, 6, 3);
		m_AxisBSRadi = 1;
	...
	}
	{
		...
		m_LongAxis = new CRenderableVertexs();
		//new CLinesListRenderableVertexs<MV_POSITION_COLOR_VERTEX>(_Device, l_LongAxisVtxs, 12, 6);
		m_LongAxisBSRadi = 1;
	...
	}
	{
		...
		m_SimpleTriangle = new CRenderableVertexs();
		//new CTrianglesListRenderableVertexs<MV_POSITION_COLOR_VERTEX>(_Device, l_SimpleTriangleVtxs, 3, 1);
	...
	}
	{
		...
		m_ClassicBlendTriangle = new CRenderableVertexs();
		//new CTrianglesListRenderableVertexs<MV_POSITION_COLOR_VERTEX>(_Device, l_SimpleTriangleVtxs, 3, 1);
	...
	}
	{
		...
		m_PremultBlendTriangle = new CRenderableVertexs();
		//new CTrianglesListRenderableVertexs<MV_POSITION_COLOR_VERTEX>(_Device, l_SimpleTriangleVtxs, 3, 1);
	...
	}
	{
		...
		m_SimpleGrid = new CRenderableVertexs();
		//new CLinesListRenderableIndexed16Vertexs<MV_POSITION_COLOR_VERTEX>(_Device, l_SimpleGridVtxs, 8, l_SimpleGridIdxs, 12);
	...
	}
	{
		...
		*/
		...
		m_SimpleCube = new CRenderableVertexs();
		//new CTriangleListRenderableIndexed16Vertexs<MV_POSITION_COLOR_VERTEX>(_Device, l_SimpleCubeVtxs, 8, l_SimpleCubeIdxs, 36);
